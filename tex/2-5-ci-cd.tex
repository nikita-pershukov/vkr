...
\Abbrev{CI/CD}{blablabla}
\Define{Continuous Integration and Continuous Delivery or Deployment}{blablabla}
...
\Define{Docker Registry}{blablabla}
...
\Abbrev{API}{blablabla}
\Define{Application Programming Interface}{blablabla}
URL
